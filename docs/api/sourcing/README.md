...
| :--- | :--- | :--- | :--- |
| **Product Search** | US-61 / UC61 | BR-384 (Persistence) | Implemented (Cross-tenant) |
| **Reputation Cache** | UC16, UC17 | ADD 1.1 | Implemented (Redis-based) |

### 2.2 Request for Quotation (RFQ)
| Feature | Use Case | Business Rules | Implementation Status |
| :--- | :--- | :--- | :--- |
| **Create Draft RFQ** | US-62 / UC62 | BR-387 (Auto-Merge) | Implemented |
| **Submit RFQ** | US-63 / UC63 | QAR (200-item cap) | Implemented (Split into Child RFQs) |
| **Manage Items** | UC62, UC63 | BR-387, BR-395 | Implemented |

### 2.3 Quotation & Negotiation
| Feature | Use Case | Business Rules | Implementation Status |
| :--- | :--- | :--- | :--- |
| **Submit Quotation** | UC32 | BR-215 to BR-220 | Implemented |
| **Negotiate Price** | UC30 | BR-205, BR-206 | Implemented (Append-only rounds) |
| **Finalize Terms** | UC31 | BR-210 to BR-214 | Implemented |
| **Select Quotation** | US-64 / UC64 | BR-212 (PO Snapshot) | Implemented (Atomic PO creation) |
...
| **TC-SRC-04** | Mutation Lock | BR-395, BR-401 | Return 409 if modifying a submitted/locked RFQ or Quotation. |
