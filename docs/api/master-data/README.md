...
| **Soft Disable/Enable** | UC11 | BR-70, BR-71 | Implemented |
| **Cache Sync** | UC11 | BR-73 | Implemented (Redis Pub/Sub) |
| **Audit Logging** | UC11 | BR-75 | Implemented |
...
| **TC-MD-04** | Status Guard | BR-70, BR-71 | `PATCH /:id` must not be able to modify `is_active` status. |
